...
class TestMetricsCalculations(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.graph = nx.Graph([(0, 1), (0, 2), (0, 4), (1, 2), (1, 3), (2, 3), (3,
            4)])
        self.digraph = nx.DiGraph([(0, 0), (0, 1), (1, 2), (2, 3), (3, 2), (3, 4),
            (4, 0), (4, 2)])
    ...
    def test_local_cluster_coeff_undirected(self):
        ...
        for node in self.graph:
            ...
            self.assertEqual(expected_results[node], result_cc, msg='Failed on' +
                ' node %d.\nExpected %f and got %f' % (node, expected_results[node],
                    result_cc))

    def test_local_cluster_coeff_directed(self):
